...
const helpImages = [
    "https://i.imgur.com/NcRvhRl.jpeg",
    "https://i.imgur.com/MV3Cqls.jpeg",
    "https://i.imgur.com/KDhmSIE.jpeg",
    "https://i.imgur.com/zUftT5W.jpeg"
];
...
module.exports.run = function ({ api, event, args, getText }) {
    ...
    if (args[0] && commands.has(args[0].toLowerCase())) {  
        ...
        const detailText = getText("moduleInfo",  
            ...
            command.config.cooldowns || 0,  
            prefix,  
            global.config.BOTNAME || "Ariful 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭"  
        );  
...
┣━━━━━━━━━━━━━━━━┫
┃ ⚙ Prefix: ${prefix}
┃ 🤖 Bot Name: ${global.config.BOTNAME || "Ariful 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭"}
┃ 👑 Owner: Ariful Islam
╰━━━━━━━━━━━━━━━━╯`;
